...
let slider_sets = new Swiper('.slider-sets__slider', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.slider-sets__wrapper--1 .slider-arrow.slider-arrow--next',
		prevEl: '.slider-sets__wrapper--1 .slider-arrow.slider-arrow--prev',
	},
	/*
	breakpoints: {
		320: {
...
if (spollersArray.length > 0) {
	...
	function setSpollerAction(e) {
		...
		if (el.hasAttribute('data-spoller') || el.closest('[data-spoller]')) {
			...
			const parent = el.hasAttribute('data-spollers') ? el : el.closest('[data-spollers]');
			// const parent = document.querySelectorAll('.spollers-item');
			...
			if (!spollersBlock.querySelectorAll('._slide').length) {
				...
				// 	items[i].classList.toggle('_active');
				//  }
